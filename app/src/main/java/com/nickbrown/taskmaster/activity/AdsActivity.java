...
public class AdsActivity extends AppCompatActivity {
    ...
    private Button adsActivityInterstitialAdButton;
    private Button adsActivityRewardAdButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adsActivityInterstitialAdButton = findViewById(R.id.AdsActivityInterstitialAdButton);
        adsActivityRewardAdButton = findViewById(R.id.AdsActivityRewardAdButton);

        // Initialize and setup ads
        initializeMobileAds();
        setupBannerAd();
        setupInterstitialAd();
        setupRewardedAd();
    ...
    private void setupInterstitialAdButton() {
        adsActivityInterstitialAdButton.setOnClickListener(v -> {
    ...
    private void setupRewardedAdButton() {
        adsActivityRewardAdButton.setOnClickListener(v -> {
            if (rewardedAd != null) {
